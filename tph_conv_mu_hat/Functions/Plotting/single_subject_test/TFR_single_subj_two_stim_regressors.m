...
addpath(genpath([rootFolder '\Data\SPM_tf\Stimuli_locked\participant_1']));
...
for i = 1
    ...
    D = spm_eeg_load([rootFolder '\Data\SPM_tf\Stimuli_locked\' subjfolder '\conv_model_atf_d_' filetag '_tosc_spm_cont.mat']);
    % Stim left
